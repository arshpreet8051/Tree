...
/*    Algorithm :
                    Logic -> . 1 to 1 mapping of horizontal distance and node
                             . Same as vertical traversal question
    ...
    je map ch kisi horizontal distance store hogia ta bs phir hor nahi krna
